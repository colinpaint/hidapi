...
//}}}
	...
	//{{{  no ddk
	// Since we're not building with the DDK, and the HID header files aren't part of the Windows SDK,
	// we define what we need ourselves. In lookup_functions(), the function pointers defined below are set
...
int HID_API_EXPORT HID_API_CALL hid_write (hid_device *dev, const unsigned char *data, size_t length)
{
	...
	if (overlapped) {
		/* Wait for the transaction to complete. This makes hid_write() synchronous. */
